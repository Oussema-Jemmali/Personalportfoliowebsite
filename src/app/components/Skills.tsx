...
export default function Skills() {
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "DHCP & DNS", level: 88 },
        { name: "ACLs & NAT", level: 82 }
      ]
    },
    {
      icon: Shield,
      ...
      skills: [
        ...
        { name: "IDS/IPS Concepts", level: 68 },
        { name: "Security Policies & Best Practices", level: 78 },
    ...
    },
    {
      ...
      color: "emerald",
      skills: [
        { name: "CI/CD Principles", level: 65 },
        { name: "Security Automation Mindset", level: 70 },
        { name: "Infrastructure as Code Basics", level: 60 },
        { name: "Container Security Concepts", level: 55 },
        { name: "Automated Security Testing", level: 62 },
        { name: "DevOps Pipeline Understanding", level: 65 }
      ]
    },
    {
      icon: Wrench,
      ...
      skills: [
        ...
        { name: "Network Monitoring Tools", level: 78 }
      ]
    }
  ];
  ...
  const getColorClasses = (color: string) => {
    return color === 'cyan'
      ? { bg: 'bg-cyan-500/10', border: 'border-cyan-500/30', text: 'text-cyan-400', progress: 'bg-cyan-400', glow: 'shadow-cyan-400/50' }
      : { bg: 'bg-emerald-500/10', border: 'border-emerald-500/30', text: 'text-emerald-400', progress: 'bg-emerald-400', glow: 'shadow-emerald-400/50' };
  };

  return (
    <section id="skills" className="py-20 bg-gradient-to-b from-transparent via-[#0a0a0a] to-transparent">
      <div className="container mx-auto px-6">
        ...
        >
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className={`text-xl font-mono ${colors.text}`}>{category.title}</h3>
                  </div>
                    ...
                    {category.skills.map((skill, skillIndex) => (
                      <div key={skillIndex}>
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className={`text-xs ${colors.text} font-mono`}>{skill.level}%</span>
                        </div>
          ...
          >
            <h3 className="text-xl font-mono text-cyan-400 mb-4">Core Competencies</h3>
