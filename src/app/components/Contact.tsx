...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert(
      "Message sent! This is a demo - in production, this would send your message.",
    );
  };
  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "jemmali.oussema1@gmail.com",
      href: "mailto:jemmali.oussema1@gmail.com",
    },
    {
      icon: Phone,
      label: "Phone",
      value: "+216 53 901 840",
      href: "tel:+216 53 901 840",
    },
  ];
  ...
  const socialLinks = [
    {
      icon: Github,
      label: "GitHub",
      href: "https://github.com/Oussema-Jemmali",
      color: "hover:text-cyan-400",
    },
    {
      icon: Linkedin,
      label: "LinkedIn",
      href: "www.linkedin.com/in/oussema-jemmali-ce",
      color: "hover:text-cyan-400",
    },
    {
      icon: Mail,
      label: "Email",
      href: "jemmali.oussema1@gmail.com",
        ...
        >
          <div className="mb-12">
            <h2 className="text-4xl md:text-5xl font-mono mb-4">
              <span className="text-cyan-400">&gt;</span> Get In
              Touch
            </h2>
            <div className="h-1 w-20 bg-gradient-to-r from-cyan-400 to-emerald-400"></div>
            <p className="mt-4 text-gray-400">
              I'm currently seeking opportunities in network
              engineering, cybersecurity, and DevSecOps. Let's
              connect!
            </p>
          </div>
            ...
            >
              ...
              <div className="p-6 bg-gradient-to-r from-cyan-950/20 to-emerald-950/20 border border-cyan-500/20 backdrop-blur-sm">
                ...
                <p className="text-sm text-gray-400">
                  Open to full-time positions, internships, and
                  freelance projects in network engineering,
