...
import { Terminal, ChevronDown, Shield, Lock, Network } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-cyan-500/10 border border-cyan-500/30 rounded-full mb-8">
              ...
              <span className="text-sm font-mono text-cyan-400">Network Engineer & Security Researcher</span>
            </div>
          </motion.div>
